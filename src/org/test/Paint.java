...
public class Paint {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement dw = wd.findElement(By.xpath("//a[@title='Paint']"));
        a.moveToElement(dw).perform();
        //
        WebElement air= wd.findElement(By.xpath("//a[@title='Interior Paint']"));
		a.moveToElement(air).perform();
		WebElement pair = wd.findElement(By.xpath("//a[@title='Ceiling Paint']"));
